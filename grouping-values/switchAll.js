...
// as a new source come wait for it complete
// if it complete before the next source come, send out it values
// otherwise, drop it values
...
console.log('# source B doesnt complete before source C comes');
